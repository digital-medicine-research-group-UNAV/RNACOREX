...
class MRNC(BaseEstimator, ClassifierMixin):
        ...
        def fit_only(self):
            ...
            self.intern_connections_ = CLGStructure2.order_interactions(self.structural_information_, self.functional_information_)

            self.connections_ = CLGStructure2.get_ranking(self.micros_+self.genes_, self.intern_connections_, self.gtf)
            ...
            self.nodos_dag_, self.clgc_ = CLGStructure2.fit_model(self.X_, self.y_, self.n_con, self.intern_connections_)
        ...
        def fit(self, X_train, y_train):
            ...
            self.nodos_dag_, self.clgc_ = CLGStructure2.fit_model(X_train, y_train, self.n_con, self.intern_connections_)
        ...
        def structure_search(self, X_train = None, y_train = None, X_test = None, y_test = None, max_models = None, link_txt = False):
            ...
            self.structure_metrics_ = CLGStructure2.structure_search(X_train, y_train, X_test, y_test, max_models, self.intern_connections_, link_txt)
        ...
        def predict(self, X_test):
            ...
            return CLGStructure2.predict_test(X_test, self.nodos_dag_, self.clgc_)['classification']
        ...
        def predict_proba(self, X_test):
            ...
            return CLGStructure2.predict_test(X_test, self.nodos_dag_, self.clgc_)['posterior']
        ...
        #     CLGStructure2.show_connections(self.micros_+self.genes_, self.intern_connections_, self.n_con, self.gtf)
        ...
        def get_network(self, k = None, save = 'url'):
            ...
            if k == None:
                ...
                CLGStructure2.get_network(self.connections_, self.n_con, save = save)
            
            else:

                CLGStructure2.get_network(self.connections_, k, save = save)
