...
class MRNC(BaseEstimator, ClassifierMixin):
        ...
        def __init__(self, n_con=20, precision = 10, mode = 'alternating', weight = 0.5, ties = 'direct'):
            ...
            Args:
                    ...
                    mode (str): The mode used for the interaction ranking.
                    weight (float): The weight used for the interaction ranking.
                    ties (str): The method used to break ties in the interaction ranking. Options are 'direct', 'indirect', and 'functional'.
