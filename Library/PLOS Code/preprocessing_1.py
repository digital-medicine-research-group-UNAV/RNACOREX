from data_preprocessing_general import preprocessing_1
...
for notebook in tqdm(notebook_names):
    ...
    if notebook == 'skcm' or notebook == 'ov' or notebook =='laml' or notebook == 'lgg':
        preprocessing_1(notebook, 0.5, 0.7, 0.05, only_noncensored = True)

    else:
        preprocessing_1(notebook, 0.5, 0.7, 0.05)